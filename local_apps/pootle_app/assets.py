...
js_editor = Bundle(
    ...
    'js/jquery/jquery.tmpl.js', 'js/jquery/jquery.jsonp.js',
    'js/jquery/jquery.textarea-expander.js', 'js/diff_match_patch.js',
    'js/editor.js', 'js/json2.js', 'js/jquery/jquery.fieldselection.js',
    'js/jquery/jquery.caret.js', 'js/jquery/jquery.highlightRegex.js',
