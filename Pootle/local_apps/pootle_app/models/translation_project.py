...
def set_data(sender, instance, raw=False, **kwargs):
    ...
    instance.abs_real_path = project_tree.get_translation_project_dir(instance.language, project_dir,
                                                                      instance.file_style, make_dirs=True)
...
def project_cleanup(sender, instance, raw=False, **kwargs):
    """deletes related autogenerated objects when Project changes drasticly"""
    if instance.id is None or raw:
