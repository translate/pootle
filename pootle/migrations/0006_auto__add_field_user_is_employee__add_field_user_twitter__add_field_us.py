...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pootle_user', 'is_employee')

        # Deleting field 'User.twitter'
        db.delete_column(u'pootle_user', 'twitter')

        # Deleting field 'User.website'
        db.delete_column(u'pootle_user', 'website')

        # Deleting field 'User.linkedin'
        db.delete_column(u'pootle_user', 'linkedin')

        # Deleting field 'User.bio'
        db.delete_column(u'pootle_user', 'bio')
