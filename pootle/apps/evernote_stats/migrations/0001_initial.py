...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubmissionStats'
        db.create_table('evernote_stats_submissionstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pootle_statistics.Submission'], unique=True, null=True)),
            ('initial_translation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('source_wordcount', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('words_added', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('words_removed', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('chars_added', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('chars_removed', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ))
        db.send_create_signal('evernote_stats', ['SubmissionStats'])


    def backwards(self, orm):
        # Deleting model 'SubmissionStats'
        db.delete_table('evernote_stats_submissionstats')
    ...
    models = {
        ...
        'evernote_stats.submissionstats': {
            'Meta': {'object_name': 'SubmissionStats'},
            'chars_added': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'chars_removed': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_translation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'source_wordcount': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'submission': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pootle_statistics.Submission']", 'unique': 'True', 'null': 'True'}),
            'words_added': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'words_removed': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'})
        },
