...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.mt_similarity'
        db.add_column('pootle_app_submission', 'mt_similarity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.similarity'
        db.delete_column('pootle_app_submission', 'similarity')

        # Deleting field 'Submission.mt_similarity'
        db.delete_column('pootle_app_submission', 'mt_similarity')
