...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.store'
        db.add_column('pootle_app_submission', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pootle_store.Store'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.store'
        db.delete_column('pootle_app_submission', 'store_id')
    ...
    models = {
        ...
        u'pootle_store.store': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_submission': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'last_submission'", 'unique': 'True', 'null': 'True', 'to': u"orm['pootle_statistics.Submission']"}),
