...
class Migration(SchemaMigration):
    depends_on = (
        ("pootle_store", "0008_move_data_from_pootle_app_suggestion"),
    )

    def forwards(self, orm):
        # Deleting field 'Submission.from_suggestion'
        db.delete_column('pootle_app_submission', 'from_suggestion_id')


    def backwards(self, orm):
        # Adding field 'Submission.from_suggestion'
        db.add_column('pootle_app_submission', 'from_suggestion',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pootle_app.Suggestion'], unique=True, null=True),
                      keep_default=False)
