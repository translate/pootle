...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pootle_statistics_scorelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pootle_profile.PootleProfile'])),
        ...
        db.send_create_signal('pootle_statistics', ['ScoreLog'])


    def backwards(self, orm):
        # Deleting model 'ScoreLog'
        db.delete_table('pootle_statistics_scorelog')
    ...
    models = {
        ...
        'pootle_statistics.scorelog': {
            ...
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pootle_statistics.Submission']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pootle_profile.PootleProfile']"}),
        ...
        'pootle_store.unit': {
            ...
            'reviewed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviewed'", 'null': 'True', 'to': "orm['pootle_profile.PootleProfile']"}),
