...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.suggestion'
        db.add_column('pootle_app_submission', 'suggestion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pootle_store.Suggestion'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.suggestion'
        db.delete_column('pootle_app_submission', 'suggestion_id')
