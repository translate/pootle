...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VirtualFolder'
        db.create_table(u'virtualfolder_virtualfolder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('filter_rules', self.gf('django.db.models.fields.TextField')()),
            ('priority', self.gf('django.db.models.fields.FloatField')(default=1)),
        ...
        # Adding M2M table for field units on 'VirtualFolder'
        m2m_table_name = db.shorten_name(u'virtualfolder_virtualfolder_units')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('virtualfolder', models.ForeignKey(orm[u'virtualfolder.virtualfolder'], null=False)),
            ('unit', models.ForeignKey(orm[u'pootle_store.unit'], null=False))
        ))
        db.create_unique(m2m_table_name, ['virtualfolder_id', 'unit_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VirtualFolder', fields ['name', 'location']
        db.delete_unique(u'virtualfolder_virtualfolder', ['name', 'location'])

        # Deleting model 'VirtualFolder'
        db.delete_table(u'virtualfolder_virtualfolder')

        # Removing M2M table for field units on 'VirtualFolder'
        db.delete_table(db.shorten_name(u'virtualfolder_virtualfolder_units'))
