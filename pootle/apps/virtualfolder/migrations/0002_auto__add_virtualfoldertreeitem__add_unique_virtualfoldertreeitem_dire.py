...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VirtualFolderTreeItem'
        db.create_table(u'virtualfolder_virtualfoldertreeitem', (
        ...
        db.create_table(m2m_table_name, (
            ...
            ('virtualfoldertreeitem', models.ForeignKey(orm[u'virtualfolder.virtualfoldertreeitem'], null=False)),
            ('store', models.ForeignKey(orm[u'pootle_store.store'], null=False))
        ))
        db.create_unique(m2m_table_name, ['virtualfoldertreeitem_id', 'store_id'])

        # Adding unique constraint on 'VirtualFolderTreeItem', fields ['directory', 'vfolder']
        db.create_unique(u'virtualfolder_virtualfoldertreeitem', ['directory_id', 'vfolder_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VirtualFolderTreeItem', fields ['directory', 'vfolder']
        db.delete_unique(u'virtualfolder_virtualfoldertreeitem', ['directory_id', 'vfolder_id'])

        # Deleting model 'VirtualFolderTreeItem'
        db.delete_table(u'virtualfolder_virtualfoldertreeitem')

        # Removing M2M table for field stores on 'VirtualFolderTreeItem'
        db.delete_table(db.shorten_name(u'virtualfolder_virtualfoldertreeitem_stores'))
    ...
    models = {
        ...
        u'virtualfolder.virtualfoldertreeitem': {
            'Meta': {'unique_together': "(('directory', 'vfolder'),)", 'object_name': 'VirtualFolderTreeItem'},
            'directory': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vf_treeitems'", 'to': "orm['pootle_app.Directory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child_vf_treeitems'", 'null': 'True', 'to': u"orm['virtualfolder.VirtualFolderTreeItem']"}),
            'pootle_path': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'stores': ('django.db.models.fields.related.ManyToManyField', [], {'db_index': 'True', 'related_name': "'parent_vf_treeitems'", 'symmetrical': 'False', 'to': u"orm['pootle_store.Store']"}),
            'vfolder': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vf_treeitems'", 'to': u"orm['virtualfolder.VirtualFolder']"})
        },
        u'virtualfolder.virtualfolder': {
            'Meta': {'unique_together': "(('name', 'location'),)", 'object_name': 'VirtualFolder'},
            'description': ('pootle.core.markup.fields.MarkupField', [], {'blank': 'True'}),
            'filter_rules': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            'priority': ('django.db.models.fields.FloatField', [], {'default': '1'}),
            'units': ('django.db.models.fields.related.ManyToManyField', [], {'db_index': 'True', 'related_name': "'vfolders'", 'symmetrical': 'False', 'to': u"orm['pootle_store.Unit']"})
        }
    }

    complete_apps = ['virtualfolder']
