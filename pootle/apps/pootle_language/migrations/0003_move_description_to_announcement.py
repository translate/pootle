...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for language in orm.Language.objects.all():
            if language.description.raw:
                ann = Announcement(active=True, title="Language instructions",
                                   body=language.description.raw,
                                   virtual_path="announcements/"+language.code)
                ann.save()
