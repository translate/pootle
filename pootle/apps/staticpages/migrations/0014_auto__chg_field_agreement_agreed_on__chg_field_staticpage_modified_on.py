...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agreement.agreed_on'
        db.alter_column(u'staticpages_agreement', 'agreed_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'StaticPage.modified_on'
        db.alter_column(u'staticpages_staticpage', 'modified_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LegalPage.modified_on'
        db.alter_column(u'staticpages_legalpage', 'modified_on', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Agreement.agreed_on'
        db.alter_column(u'staticpages_agreement', 'agreed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'StaticPage.modified_on'
        db.alter_column(u'staticpages_staticpage', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LegalPage.modified_on'
        db.alter_column(u'staticpages_legalpage', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'staticpages.agreement': {
            'Meta': {'unique_together': "(('user', 'document'),)", 'object_name': 'Agreement'},
            'agreed_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['staticpages.LegalPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.User']"})
        },
        u'staticpages.legalpage': {
