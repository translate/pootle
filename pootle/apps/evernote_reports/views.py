...
def user_date_prj_activity(request):
    ...
    if user:
        rr = Submission.objects.filter(submitter=user.pootleprofile,
             ...
             .annotate(pootle_n1=Sum(POOTLE_WORDCOUNT),
        ...
        for r in rr:
            ...
            pootle_n1_cond = r.has_key('pootle_n1') and r['pootle_n1'] is not None
...
def users(request):
    json = list(User.objects.hide_defaults() \
