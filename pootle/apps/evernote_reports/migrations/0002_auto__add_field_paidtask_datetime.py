...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaidTask.datetime'
        db.add_column(u'evernote_reports_paidtask', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaidTask.datetime'
        db.delete_column(u'evernote_reports_paidtask', 'datetime')
    ...
    models = {
        u'evernote_reports.paidtask': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'task_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'db_index': 'True'}),
    ...
    complete_apps = ['evernote_reports']