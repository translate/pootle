...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaidTask.date'
        db.delete_column(u'evernote_reports_paidtask', 'date')

        # Changing field 'PaidTask.datetime'
        db.alter_column(u'evernote_reports_paidtask', 'datetime',
                        self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now()))

    def backwards(self, orm):
        # Adding field 'PaidTask.date'
        db.add_column(u'evernote_reports_paidtask', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now(), db_index=True),
                      keep_default=False)


        # Changing field 'PaidTask.datetime'
        db.alter_column(u'evernote_reports_paidtask', 'datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
