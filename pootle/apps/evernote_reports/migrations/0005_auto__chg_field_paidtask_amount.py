...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidTask.amount'
        db.alter_column(u'evernote_reports_paidtask', 'amount', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'PaidTask.amount'
        db.alter_column(u'evernote_reports_paidtask', 'amount', self.gf('django.db.models.fields.PositiveIntegerField')())
