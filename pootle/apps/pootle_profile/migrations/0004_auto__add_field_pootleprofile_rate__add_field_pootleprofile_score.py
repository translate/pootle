...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PootleProfile.rate'
        db.add_column('pootle_app_pootleprofile', 'rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PootleProfile.score'
        db.add_column('pootle_app_pootleprofile', 'score',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PootleProfile.rate'
        db.delete_column('pootle_app_pootleprofile', 'rate')

        # Deleting field 'PootleProfile.score'
        db.delete_column('pootle_app_pootleprofile', 'score')
