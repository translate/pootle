...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PootleProfile.review_rate'
        db.add_column('pootle_app_pootleprofile', 'review_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PootleProfile.review_rate'
        db.delete_column('pootle_app_pootleprofile', 'review_rate')
