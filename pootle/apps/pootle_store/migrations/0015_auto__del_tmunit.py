...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding model 'TMUnit'
        db.create_table(u'pootle_store_tmunit', (
            ...
            ('submitted_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True, db_index=True)),
            ...
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tmunit_submitted_by', null=True, to=orm['accounts.User'])),
        ...
        db.send_create_signal(u'pootle_store', ['TMUnit'])
