...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pootle_store_suggestion', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews', null=True, to=orm['pootle_profile.PootleProfile']),
                      keep_default=False)

        # Adding field 'Suggestion.translation_project'
        db.add_column(u'pootle_store_suggestion', 'translation_project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggestions', null=True, to=orm['pootle_translationproject.TranslationProject']),
                      keep_default=False)

        # Adding field 'Suggestion.state'
        db.add_column(u'pootle_store_suggestion', 'state',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=16, db_index=True),
                      keep_default=False)

        # Adding field 'Suggestion.creation_time'
        db.add_column(u'pootle_store_suggestion', 'creation_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Suggestion.review_time'
        db.add_column(u'pootle_store_suggestion', 'review_time',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pootle_store_suggestion', 'reviewer_id')

        # Deleting field 'Suggestion.translation_project'
        db.delete_column(u'pootle_store_suggestion', 'translation_project_id')

        # Deleting field 'Suggestion.state'
        db.delete_column(u'pootle_store_suggestion', 'state')

        # Deleting field 'Suggestion.creation_time'
        db.delete_column(u'pootle_store_suggestion', 'creation_time')

        # Deleting field 'Suggestion.review_time'
        db.delete_column(u'pootle_store_suggestion', 'review_time')
    ...
    models = {
        ...
        u'pootle_store.suggestion': {
            ...
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviews'", 'null': 'True', 'to': u"orm['pootle_profile.PootleProfile']"}),
            ...
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pootle_store.Unit']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'suggestions'", 'null': 'True', 'to': u"orm['pootle_profile.PootleProfile']"})
        },
