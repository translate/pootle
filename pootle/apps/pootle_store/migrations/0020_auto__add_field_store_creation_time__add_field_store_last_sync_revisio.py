...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.creation_time'
        db.add_column(u'pootle_store_store', 'creation_time',
        ...
        db.add_column(u'pootle_store_store', 'last_sync_revision',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Store.obsolete'
        db.add_column(u'pootle_store_store', 'obsolete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.creation_time'
        db.delete_column(u'pootle_store_store', 'creation_time')

        # Deleting field 'Store.last_sync_revision'
        db.delete_column(u'pootle_store_store', 'last_sync_revision')

        # Deleting field 'Store.obsolete'
        db.delete_column(u'pootle_store_store', 'obsolete')
