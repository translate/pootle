...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'pootle_store_suggestion', ['unit_id', 'target_hash'])


        # Changing field 'Suggestion.creation_time'
        db.alter_column(u'pootle_store_suggestion', 'creation_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Suggestion.creation_time'
        db.alter_column(u'pootle_store_suggestion', 'creation_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Adding unique constraint on 'Suggestion', fields ['unit', 'target_hash']
        db.create_unique(u'pootle_store_suggestion', ['unit_id', 'target_hash'])
