...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.reviewed_by'
        db.add_column(u'pootle_store_unit', 'reviewed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewed', null=True, to=orm['accounts.User']),
                      keep_default=False)

        # Adding field 'Unit.reviewed_on'
        db.add_column(u'pootle_store_unit', 'reviewed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)


        # Changing field 'Unit.commented_on'
        db.alter_column(u'pootle_store_unit', 'commented_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Unit.submitted_on'
        db.alter_column(u'pootle_store_unit', 'submitted_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Unit.reviewed_by'
        db.delete_column(u'pootle_store_unit', 'reviewed_by_id')

        # Deleting field 'Unit.reviewed_on'
        db.delete_column(u'pootle_store_unit', 'reviewed_on')


        # Changing field 'Unit.commented_on'
        db.alter_column(u'pootle_store_unit', 'commented_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Unit.submitted_on'
        db.alter_column(u'pootle_store_unit', 'submitted_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
