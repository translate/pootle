...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pootle_store_unit', 'reviewed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewed', null=True, to=orm['pootle_profile.PootleProfile']),
                      keep_default=False)

        # Adding field 'Unit.reviewed_on'
        db.add_column('pootle_store_unit', 'reviewed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Unit.reviewed_by'
        db.delete_column('pootle_store_unit', 'reviewed_by_id')

        # Deleting field 'Unit.reviewed_on'
        db.delete_column('pootle_store_unit', 'reviewed_on')
