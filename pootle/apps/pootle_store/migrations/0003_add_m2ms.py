...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pootle_store_unit', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='submitted', null=True, to=orm['accounts.User']),
                      keep_default=False)

        # Adding field 'Unit.commented_by'
        db.add_column('pootle_store_unit', 'commented_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commented', null=True, to=orm['accounts.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'pootle_store.tmunit': {
            ...
            'submitted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tmunit_submitted_by'", 'null': 'True', 'to': "orm['accounts.User']"}),
