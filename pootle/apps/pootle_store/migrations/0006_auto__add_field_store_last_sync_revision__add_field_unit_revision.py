...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pootle_store_unit', 'revision',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('pootle_store_store', 'last_sync_revision')

        # Deleting field 'Unit.revision'
        db.delete_column('pootle_store_unit', 'revision')
