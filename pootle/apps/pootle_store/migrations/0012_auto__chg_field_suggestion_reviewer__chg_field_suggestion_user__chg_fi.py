...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index(u'pootle_store_unit', ['submitted_by_id'])
        db.create_index(u'pootle_store_unit', ['commented_by_id'])
        
        # Changing field 'Suggestion.reviewer'
        db.alter_column(u'pootle_store_suggestion', 'reviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle.User']))

        # Changing field 'Suggestion.user'
        db.alter_column(u'pootle_store_suggestion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle.User']))

        # Changing field 'Unit.reviewed_by'
        db.alter_column(u'pootle_store_unit', 'reviewed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle.User']))

        # Changing field 'Unit.commented_by'
        db.alter_column(u'pootle_store_unit', 'commented_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle.User']))

        # Changing field 'Unit.submitted_by'
        db.alter_column(u'pootle_store_unit', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle.User']))

    def backwards(self, orm):

        # Changing field 'Suggestion.reviewer'
        db.alter_column(u'pootle_store_suggestion', 'reviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle_profile.PootleProfile']))

        # Changing field 'Suggestion.user'
        db.alter_column(u'pootle_store_suggestion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle_profile.PootleProfile']))

        # Changing field 'Unit.reviewed_by'
        db.alter_column(u'pootle_store_unit', 'reviewed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle_profile.PootleProfile']))

        # Changing field 'Unit.commented_by'
        db.alter_column(u'pootle_store_unit', 'commented_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle_profile.PootleProfile']))

        # Changing field 'Unit.submitted_by'
        db.alter_column(u'pootle_store_unit', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle_profile.PootleProfile']))
