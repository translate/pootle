...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TranslationProject.description'
        db.delete_column('pootle_app_translationproject', 'description')


    def backwards(self, orm):
        # Adding field 'TranslationProject.description'
        db.add_column('pootle_app_translationproject', 'description',
                      self.gf('pootle.core.markup.fields.MarkupField')(default='', blank=True),
                      keep_default=False)
