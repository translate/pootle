...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TranslationProject.creation_time'
        db.add_column('pootle_app_translationproject', 'creation_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TranslationProject.creation_time'
        db.delete_column('pootle_app_translationproject', 'creation_time')
