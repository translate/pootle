...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'profile' field to 'user'
        db.rename_column("pootle_app_permissionset", "profile_id", "user_id")

    def backwards(self, orm):
        # Rename 'user' field to 'profile'
        db.rename_column("pootle_app_permissionset", "user_id", "profile_id")
