...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Delete stray django-registration content type.
        orm['contenttypes.ContentType'].objects.filter(
            app_label='registration', model='registrationprofile'
        ).delete()

        # Delete content type for auth.User that won't be necessary anymore.
        orm['contenttypes.ContentType'].objects.filter(
