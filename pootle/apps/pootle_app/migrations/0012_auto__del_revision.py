...
class Migration(SchemaMigration):
    depends_on = (
        ("pootle_app", "0011_auto__del_pootlesite"),
        ("pootle_statistics", "0010_drop_submitterless_submissions"),
        ("pootle_store", "0021_set_reviewer_data"),
    )

    def forwards(self, orm):
        # Deleting model 'Revision'
        ContentType.objects.filter(app_label='pootle_app', model='revision').delete()
