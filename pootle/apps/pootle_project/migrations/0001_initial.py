    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localfiletype', models.CharField(default=b'po', max_length=50, verbose_name='File Type', choices=[(b'po', 'Gettext PO'), (b'xlf', 'XLIFF'), (b'ts', 'Qt ts'), (b'tmx', 'TMX'), (b'tbx', 'TBX'), (b'catkeys', 'Haiku catkeys'), (b'csv', 'Excel CSV'), (b'lang', 'Mozilla .lang')])),
