...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pootle_app_project', (
            ...
            ('source_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pootle_language.Language'])),
            ...
            ('screenshot_search_prefix', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal(u'pootle_project', ['Project'])
