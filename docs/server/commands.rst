...
.. note:: If you have modified your project's template files, executing 
   :djadmin:`update_stores` will **only** update the template language
   in the database. If you wish to update the other languages to reflect
   the changes made to the template language, you must make use of
