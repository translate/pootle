...
# Pootle; if not, write to the Free Software Foundation, Inc., 59 Temple Place,
...
class pootlestatistics:
    ...
    def getquickstats(self):
        ...
        try:
            return self.statscache.filetotals(self.basefile.filename)\
                 or statsdb.emptyfiletotals()
        except:
            _complain(u'Could not compute file totals for %s',
    ...
    def getstats(self, checker=None):
        ...
        try:
            ...
            _complain(u'Could not compute statistics for %s',
                      self.basefile.filename)
    ...
    def getunitstats(self):
        try:
            ...
            _complain(u'Could not compute word counts for %s',
                      self.basefile.filename)
    ...
    def reclassifyunit(self, item):
        ...
        self.statscache.recacheunit(self.basefile.filename,
                                    self.basefile.checker, unit)
        self._memoize_table = {}
